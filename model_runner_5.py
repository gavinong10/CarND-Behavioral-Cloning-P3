...
{**template, **{
    "optimizer": 'Adam',
    "lr": 0.0001,
    "output_path": 'training4_high_lr/Nadam_std_+_firsthardrightfwddirt_lr0.0001',
    "track1_data_dirs": ['data_download', 'avoid_dirt', 'first_hard_right_fwd'],
    "LOAD_MODEL": 'training4_high_lr/Nadam_std_+_firsthardrightfwddirt_lr0.001/model_epoch_30.h5',
    "EPOCHS": 50,
}},
{**template, **{
    "optimizer": 'Adam',
    "lr": 0.00005,
    "output_path": 'training4_high_lr/Nadam_std_+_firsthardrightfwddirt_lr0.00005',
    "track1_data_dirs": ['data_download', 'avoid_dirt', 'first_hard_right_fwd'],
    "LOAD_MODEL": 'training4_high_lr/Nadam_std_+_firsthardrightfwddirt_lr0.0001/model_epoch_50.h5',
    "EPOCHS": 70,
}}]
